...
if [[ -x /Users/chrishunter/vscode-workspace/open-ispf/data/SYS1/LOADLIB/IEFBR14 ]]; then
  /Users/chrishunter/vscode-workspace/open-ispf/data/SYS1/LOADLIB/IEFBR14 --dd 'DD1|GP5CRH.BR14NEW.TEST|OLD|DELETE|/Users/chrishunter/vscode-workspace/open-ispf/data/GP5CRH/BR14NEW_TEST.dat'
  step_rc=$?
